...
Variation.create = function(attrs, baseDir, actions) {
  actions = Array.isArray(actions) ? actions : [];
  //create directory
  fileUtil.writeDir(baseDir);
  actions.forEach(function(action) {
    fileUtil.writeDir(path.join(baseDir, String(action.page_id)));
    fileUtil.writeText(path.join(baseDir, String(action.page_id), Variation.JS_FILE_NAME));
    fileUtil.writeText(path.join(baseDir, String(action.page_id), Variation.CSS_FILE_NAME));
  });
